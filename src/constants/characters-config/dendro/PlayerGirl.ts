...
@Icons("UI_AvatarIcon_PlayerGirl", "PlayerGrass")
export class PlayerGirlData extends Character implements ICharacterInfo {
  ...
  burstSkill = [
    action("草灯莲攻击伤害", AttackType.Burst, ElementType.Dendro, {
      atk: [
        0.8016, 0.86172, 0.92184, 1.002, 1.06212, 1.12224, 1.2024, 1.28256, 1.36272, 1.44288, 1.52304, 1.6032, 1.7034,
        1.8036, 1.9038,
      ],
    }),
    action("激烈爆发伤害", AttackType.Burst, ElementType.Dendro, {
      atk: [
        4.008, 4.3086, 4.6092, 5.01, 5.3106, 5.6112, 6.012, 6.4128, 6.8136, 7.2144, 7.6152, 8.016, 8.517, 9.018, 9.519,
      ],
    }),
  ];
  otherSkill = [];
...
/** ![荧·草](https://enka.network/ui/UI_AvatarIcon_PlayerGirl.png) */
