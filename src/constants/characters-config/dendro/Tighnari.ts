...
class TighnariData extends Character implements ICharacterInfo {
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Tighnari"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Tighnari"),
  };
  ...
  normalAttack = [
    ...
    this.action("一段蓄力瞄准射击", AttackType.Strong, ElementType.Dendro, {
      atk: [1.24, 1.33, 1.43, 1.55, 1.64, 1.74, 1.86, 1.98, 2.11, 2.23, 2.36],
    }),
    this.action("花筥箭伤害", AttackType.Strong, ElementType.Dendro, {
      atk: [0.872, 0.937, 1.003, 1.09, 1.155, 1.221, 1.308, 1.395, 1.482, 1.57, 1.657],
    }),
    this.action("藏蕴花矢伤害", AttackType.Strong, ElementType.Dendro, {
  ...
  burstSkill = [
    this.action("缠藤箭伤害", AttackType.Burst, ElementType.Dendro, {
      atk: [0.556, 0.598, 0.64, 0.695, 0.737, 0.779, 0.834, 0.89, 0.946, 1.001, 1.057, 1.112, 1.182],
    }),
    this.action("次级缠藤箭伤害", AttackType.Burst, ElementType.Dendro, {
      atk: [0.68, 0.731, 0.782, 0.85, 0.901, 0.952, 1.02, 1.088, 1.156, 1.224, 1.292, 1.36, 1.445],
    }),
  ];
  otherSkill = [
    this.action("6命·藏蕴花矢伤害", AttackType.Strong, ElementType.Dendro, {
      atk: [1.5],
    }),
  ];
  buffs: IBuffBase[] = [
