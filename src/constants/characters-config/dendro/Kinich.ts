...
class KinichData extends Character implements ICharacterInfo {
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Kinich"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Kinich"),
  };
  ...
  normalAttack = [
    ...
    this.action("空中普通攻击伤害", AttackType.Normal, ElementType.Physical, {
  ...
  elementSkill = [
    this.action("环绕射击伤害", AttackType.Skill, ElementType.Dendro, {
  ...
  burstSkill = [
    this.action("技能伤害", AttackType.Burst, ElementType.Dendro, {
      atk: [1.34, 1.441, 1.541, 1.675, 1.776, 1.876, 2.01, 2.144, 2.278, 2.412, 2.546, 2.68, 2.848],
    }),
    this.action("龙息伤害", AttackType.Burst, ElementType.Dendro, {
