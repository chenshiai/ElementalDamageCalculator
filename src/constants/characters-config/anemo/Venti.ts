...
export class VentiData extends Character implements ICharacterInfo {
  ...
  normalAttack = [
    ...
    action(
      ...
      {
        atk: [
          0.44376, 0.47988, 0.516, 0.5676, 0.60372, 0.645, 0.70176, 0.75852, 0.81528, 0.8772, 0.94815, 1.031587,
          1.115024, 1.198462, 1.289484,
        ],
      },
      "Venti"
    ),
  ...
  buffs: IBuffBase[] = [
    ...
    {
      label: "魔女的前夜礼·颂时风若",
      describe: `元素爆发风神之诗创造的暴风之眼存在期间，附近的当前场上角色触发扩散反应后的4秒内，该角色造成的伤害提升50%，并使温迪自己的暴风之眼造成原本135%的伤害。温迪的普通攻击将转为发射能穿透敌人的飓风箭，对路径上的敌人造成更高的风元素伤害。`,
      effect: [
        { type: BuffType.GlobalPrcent, getValue: (_, s) => s * 50 },
        { type: BuffType.BurstRate, getValue: () => 35 },
        { type: BuffType.Transform, getValue: () => EnchantingType[ElementType.Anemo], special: "Venti" },
        { type: BuffType.NormalRate, getValue: () => 150 },
      ],
      enable: true,
      stack: 1,
      limit: 1,
    ...
    {
      label: "魔女的前夜礼·颂时风若",
      describe: `元素爆发风神之诗创造的暴风之眼存在期间，附近的当前场上角色触发扩散反应后的4秒内，该角色造成的伤害提升50%。`,
    ...
    {
      label: "2命·眷恋的泠风",
      describe: `高天之歌会使敌人的风元素抗性与物理抗性降低24%。`,
      effect: [
        { type: BuffType.EnemyAnemoResistance, getValue: () => -24 },
        { type: BuffType.EnemyPhysicalResistance, getValue: () => -24 },
      ],
      enable: true,
      shareable: true,
    ...
    {
      label: "2命·眷恋的泠风·风起之时",
      describe: `点按施放元素战技高天之歌时，将造成原本300%的伤害。`,
      effect: [{ type: BuffType.SkillRate, getValue: () => 200, special: "venti" }],
      enable: true,
      condition: ({ constellation }) => constellation >= 2,
    },
    Constellation_Q_3,
    {
      label: "4命·自由的凛风",
      describe: `温迪施放元素战技高天之歌或元素爆发风神之诗后，温迪与队伍中自己的当前场上其他角色获得25%风元素伤害加成`,
    ...
    {
      label: "6命·抗争的暴风·暴伤",
      describe: `温迪对受风神之诗伤害的敌人造成伤害，还会获得100%暴击伤害加成。 `,
      effect: [{ type: BuffType.GlobalCritcalHunt, getValue: () => 100 }],
      enable: true,
