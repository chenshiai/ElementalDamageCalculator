...
export class LinetteData extends Character implements ICharacterInfo {
  ...
  normalAttack = [
    action("一段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.430817, 0.465884, 0.50095, 0.551045, 0.586112, 0.626188, 0.681292, 0.736397, 0.791501, 0.851615, 0.911729,
        0.971843, 1.031957, 1.092071, 1.152185,
      ],
    }),
    action("二段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.376121, 0.406736, 0.43735, 0.481085, 0.511699, 0.546687, 0.594796, 0.642904, 0.691013, 0.743495, 0.795977,
        0.848459, 0.900941, 0.953423, 1.005905,
      ],
    }),
    action("三段伤害·1", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.27864, 0.30132, 0.324, 0.3564, 0.37908, 0.405, 0.44064, 0.47628, 0.51192, 0.5508, 0.58968, 0.62856, 0.66744,
        0.70632, 0.7452,
      ],
    }),
    action("三段伤害·2", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.215929, 0.233504, 0.25108, 0.276188, 0.293764, 0.31385, 0.341469, 0.369088, 0.396706, 0.426836, 0.456966,
        0.487095, 0.517225, 0.547354, 0.577484,
      ],
    }),
    action("四段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.631541, 0.682945, 0.73435, 0.807785, 0.859189, 0.917937, 0.998716, 1.079494, 1.160273, 1.248395, 1.336517,
        1.424639, 1.512761, 1.600883, 1.689005,
      ],
    }),
    action("重击伤害·1", AttackType.Strong, ElementType.Physical, {
      atk: [
        0.44204, 0.47802, 0.514, 0.5654, 0.60138, 0.6425, 0.69904, 0.75558, 0.81212, 0.8738, 0.93548, 0.99716, 1.05884,
        1.12052, 1.1822,
      ],
    }),
    action("重击伤害·2", AttackType.Strong, ElementType.Physical, {
      atk: [
        0.61404, 0.66402, 0.714, 0.7854, 0.83538, 0.8925, 0.97104, 1.04958, 1.12812, 1.2138, 1.29948, 1.38516, 1.47084,
        1.55652, 1.6422,
      ],
    }),
  ...
  elementSkill = [
    action("谜影突刺伤害", AttackType.Skill, ElementType.Anemo, {
      atk: [2.68, 2.881, 3.082, 3.35, 3.551, 3.752, 4.02, 4.288, 4.556, 4.824, 5.092, 5.36, 5.695, 6.03, 6.365],
    }),
    action("流涌之刃伤害", AttackType.Skill, ElementType.Anemo, {
      atk: [
        0.312, 0.3354, 0.3588, 0.39, 0.4134, 0.4368, 0.468, 0.4992, 0.5304, 0.5616, 0.5928, 0.624, 0.663, 0.702, 0.741,
      ],
    }),
  ];
  burstSkill = [
    action("技能伤害", AttackType.Burst, ElementType.Anemo, {
      atk: [
        0.832, 0.8944, 0.9568, 1.04, 1.1024, 1.1648, 1.248, 1.3312, 1.4144, 1.4976, 1.5808, 1.664, 1.768, 1.872, 1.976,
      ],
    }),
    action("惊奇猫猫盒伤害", AttackType.Burst, ElementType.Anemo, {
      atk: [
        0.512, 0.5504, 0.5888, 0.64, 0.6784, 0.7168, 0.768, 0.8192, 0.8704, 0.9216, 0.9728, 1.024, 1.088, 1.152, 1.216,
      ],
    }),
    action("彩练术弹伤害·水", AttackType.Burst, ElementType.Hydro, {
      atk: [
        0.456, 0.4902, 0.5244, 0.57, 0.6042, 0.6384, 0.684, 0.7296, 0.7752, 0.8208, 0.8664, 0.912, 0.969, 1.026, 1.083,
      ],
    }),
