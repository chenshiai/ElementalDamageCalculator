...
class MizukiData extends Character implements ICharacterInfo {
  constructor() {
    super();
  }
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Mizuki"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Mizuki"),
  };
  ...
  elementSkill = [
    ...
    this.action("持续攻击伤害", AttackType.Skill, ElementType.Anemo, {
  ...
  burstSkill = [
    ...
    this.action("梦念冲击波伤害", AttackType.Burst, ElementType.Anemo, {
      atk: [0.706, 0.758, 0.811, 0.882, 0.935, 0.988, 1.057, 1.129, 1.2, 1.27, 1.341, 1.411, 1.499],
    }),
    this.action("拾取点心回复生命值", AttackType.Heal, ElementType.None, {
