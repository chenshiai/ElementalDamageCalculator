...
export class SayuData extends Character implements ICharacterInfo {
  ...
  normalAttack = [
    action("一段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.7224, 0.7812, 0.84, 0.924, 0.9828, 1.05, 1.1424, 1.2348, 1.3272, 1.428, 1.5435, 1.679328, 1.815156, 1.950984,
        2.09916,
      ],
    }),
    action("二段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.7138, 0.7719, 0.83, 0.913, 0.9711, 1.0375, 1.1288, 1.2201, 1.3114, 1.411, 1.525125, 1.659336, 1.793547,
        1.927758, 2.07417,
      ],
    }),
    action("三段伤害·单次", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.4343, 0.46965, 0.505, 0.5555, 0.59085, 0.63125, 0.6868, 0.74235, 0.7979, 0.8585, 0.927937, 1.009596, 1.091255,
        1.172913, 1.261995,
      ],
    }),
    action("四段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.98126, 1.06113, 1.141, 1.2551, 1.33497, 1.42625, 1.55176, 1.67727, 1.80278, 1.9397, 2.096588, 2.281087,
        2.465587, 2.650087, 2.851359,
      ],
    }),
  ...
  elementSkill = [
    ...
    action(
      ...
      {
        atk: [
          1.584, 1.7028, 1.8216, 1.98, 2.0988, 2.2176, 2.376, 2.5344, 2.6928, 2.8512, 3.0096, 3.168, 3.366, 3.564,
          3.762,
        ],
      },
      "sayo"
    ...
    action(
      ...
      {
        atk: [
          0.7616, 0.81872, 0.87584, 0.952, 1.00912, 1.06624, 1.1424, 1.21856, 1.29472, 1.37088, 1.44704, 1.5232, 1.6184,
          1.7136, 1.8088,
        ],
      },
      "sayo"
  ...
  burstSkill = [
    action("技能发动伤害", AttackType.Burst, ElementType.Anemo, {
      atk: [
        1.168, 1.2556, 1.3432, 1.46, 1.5476, 1.6352, 1.752, 1.8688, 1.9856, 2.1024, 2.2192, 2.336, 2.482, 2.628, 2.774,
      ],
    }),
    action("不倒貉貉伤害", AttackType.Burst, ElementType.Anemo, {
      atk: [0.52, 0.559, 0.598, 0.65, 0.689, 0.728, 0.78, 0.832, 0.884, 0.936, 0.988, 1.04, 1.105, 1.17, 1.235],
    }),
    action("技能发动治疗量", AttackType.Heal, ElementType.None, {
      atk: [
        0.9216, 0.99072, 1.05984, 1.152, 1.22112, 1.29024, 1.3824, 1.47456, 1.56672, 1.65888, 1.75104, 1.8432, 1.9584,
        2.0736, 2.1888,
      ],
      fixed: [
    ...
    action("不倒貉貉治疗量", AttackType.Heal, ElementType.None, {
      ...
      fixed: [
        500.3603, 550.40326, 604.6165, 663, 725.5537, 792.2777, 863.17194, 938.2364, 1017.4711, 1100.8761, 1188.4513,
        1280.1968, 1376.1125, 1476.1985, 1580.4547,
      ],
    }),
  ];
  otherSkill = [
