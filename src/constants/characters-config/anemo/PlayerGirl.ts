...
export class PlayerGirlData extends Character implements ICharacterInfo {
  ...
  burstSkill = [
    action("龙卷风伤害", AttackType.Burst, ElementType.Anemo, {
      atk: [0.808,0.8686,0.9292,1.01,1.0706,1.1312,1.212,1.2928,1.3736,1.4544,1.5352,1.616,1.717,1.818,1.919],
    }),
    action("附加元素伤害·火", AttackType.Burst, ElementType.Pyro, {
      atk: [0.248,0.2666,0.2852,0.31,0.3286,0.3472,0.372,0.3968,0.4216,0.4464,0.4712,0.496,0.527,0.558,0.589],
    }),
