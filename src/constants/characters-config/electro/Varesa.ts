...
class VaresaData extends Character implements ICharacterInfo {
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Varesa"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Varesa"),
  };
  talentNames = ["普通攻击·角力搏摔", "夜虹逐跃", "闪烈降临！"];

  normalAttack = [
    this.action("一段伤害", AttackType.Normal, ElementType.Electro, {
      atk: [0.468, 0.503, 0.538, 0.585, 0.62, 0.655, 0.702, 0.748, 0.795, 0.842, 0.889, 0.936, 0.994, 1.052],
    }),
    this.action("二段伤害", AttackType.Normal, ElementType.Electro, {
      atk: [0.4, 0.43, 0.46, 0.5, 0.53, 0.56, 0.6, 0.64, 0.68, 0.721, 0.76, 0.801, 0.851, 0.901],
    }),
    this.action("三段伤害", AttackType.Normal, ElementType.Electro, {
