...
class IansanData extends Character implements ICharacterInfo {
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Iansan"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Iansan"),
  };
  ...
  normalAttack = [
    ...
    this.action("雷霆飞缒伤害", AttackType.Strong, ElementType.Electro, {
  ...
  burstSkill = [
    this.action("技能伤害", AttackType.Burst, ElementType.Electro, {
      atk: [4.304, 4.627, 4.95, 5.38, 5.703, 6.026, 6.456, 6.886, 7.317, 7.747, 8.178, 8.608, 9.146],
    }),
  ];
  otherSkill = [
    this.action("「热身效应」治疗量", AttackType.Heal, ElementType.None, {
      atk: [0.6],
    }),
  ];
  buffs = [
