...
export class YaeData extends Character implements ICharacterInfo {
  ...
  normalAttack = [
    action("一段伤害", AttackType.Normal, ElementType.Electro, {
      atk: [
        0.396584, 0.426328, 0.456072, 0.49573, 0.525474, 0.555218, 0.594876, 0.634534, 0.674193, 0.713851, 0.75351,
        0.793168, 0.842741, 0.892314, 0.941887,
      ],
    }),
    action("二段伤害", AttackType.Normal, ElementType.Electro, {
      atk: [
        0.385192, 0.414081, 0.442971, 0.48149, 0.510379, 0.539269, 0.577788, 0.616307, 0.654826, 0.693346, 0.731865,
        0.770384, 0.818533, 0.866682, 0.914831,
      ],
    }),
    action("三段伤害", AttackType.Normal, ElementType.Electro, {
      atk: [
        0.568888, 0.611555, 0.654221, 0.71111, 0.753777, 0.796443, 0.853332, 0.910221, 0.96711, 1.023998, 1.080887,
        1.137776, 1.208887, 1.28, 1.351109,
      ],
    }),
    action("重击", AttackType.Strong, ElementType.Electro, {
      atk: [
        1.428948, 1.53612, 1.643291, 1.786185, 1.893357, 2.000528, 2.143423, 2.286317, 2.429212, 2.572107, 2.715002,
        2.857897, 3.036515, 3.215134, 3.393752,
      ],
    }),
  ...
  elementSkill = [
    action(
      ...
      {
        atk: [
          0.60672, 0.652224, 0.697728, 0.7584, 0.803904, 0.849408, 0.91008, 0.970752, 1.031424, 1.092096, 1.152768,
          1.21344, 1.28928, 1.36512, 1.44096,
        ],
      },
      "Yae"
    ),
    action(
      ...
      {
        atk: [
          0.7584, 0.81528, 0.87216, 0.948, 1.00488, 1.06176, 1.1376, 1.21344, 1.28928, 1.36512, 1.44096, 1.5168, 1.6116,
          1.7064, 1.8012,
        ],
      },
      "Yae"
    ...
    action(
      ...
      {
        atk: [
          0.948, 1.0191, 1.0902, 1.185, 1.2561, 1.3272, 1.422, 1.5168, 1.6116, 1.7064, 1.8012, 1.896, 2.0145, 2.133,
          2.2515,
        ],
      },
      "Yae"
    ...
    action(
      ...
      {
        atk: [
          1.185, 1.273875, 1.36275, 1.48125, 1.570125, 1.659, 1.7775, 1.896, 2.0145, 2.133, 2.2515, 2.37, 2.518125,
          2.66625, 2.814375,
        ],
      },
      "Yae"
  ...
  burstSkill = [
    action("技能伤害", AttackType.Burst, ElementType.Electro, {
      atk: [2.6, 2.795, 2.99, 3.25, 3.445, 3.64, 3.9, 4.16, 4.42, 4.68, 4.94, 5.2, 5.525, 5.85, 6.175],
    }),
    action("天狐霆雷伤害", AttackType.Burst, ElementType.Electro, {
      atk: [
        3.33816, 3.588522, 3.838884, 4.1727, 4.423062, 4.673424, 5.00724, 5.341056, 5.674872, 6.008688, 6.342504,
        6.67632, 7.09359, 7.51086, 7.92813,
      ],
    }),
  ];
  otherSkill = [];
