...
class NaviaData extends Character implements ICharacterInfo {
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Navia"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Navia"),
  };
  ...
  normalAttack = [
    ...
    this.action("重击循环伤害", AttackType.Strong, ElementType.Physical, {
      atk: [0.625, 0.676, 0.727, 0.8, 0.851, 0.909, 0.989, 1.069, 1.149, 1.236, 1.323],
    }),
    this.action("重击终结伤害", AttackType.Strong, ElementType.Physical, {
      atk: [1.131, 1.223, 1.315, 1.447, 1.539, 1.644, 1.788, 1.933, 2.078, 2.236, 2.393],
    }),
    this.action("下落期间伤害", AttackType.FallPeriod, ElementType.Physical, {
  ...
  elementSkill = [
    this.action("玫瑰晶弹伤害·5枚", AttackType.Skill, ElementType.Geo, {
      atk: [3.948, 4.244, 4.54, 4.935, 5.231, 5.527, 5.922, 6.317, 6.712, 7.106, 7.501, 7.896, 8.39].map(
        (i) => i * 1.2
      ),
    }),
    this.action("玫瑰晶弹伤害·7枚", AttackType.Skill, ElementType.Geo, {
      atk: [3.948, 4.244, 4.54, 4.935, 5.231, 5.527, 5.922, 6.317, 6.712, 7.106, 7.501, 7.896, 8.39].map(
        (i) => i * 1.4
      ),
    }),
    this.action("玫瑰晶弹伤害·9枚", AttackType.Skill, ElementType.Geo, {
      atk: [3.948, 4.244, 4.54, 4.935, 5.231, 5.527, 5.922, 6.317, 6.712, 7.106, 7.501, 7.896, 8.39].map(
        (i) => i * 1.66
      ),
    }),
    this.action("玫瑰晶弹伤害·11枚", AttackType.Skill, ElementType.Geo, {
      atk: [3.948, 4.244, 4.54, 4.935, 5.231, 5.527, 5.922, 6.317, 6.712, 7.106, 7.501, 7.896, 8.39].map((i) => i * 2),
    }),
    this.action("流涌之刃伤害", AttackType.Other, ElementType.Geo, {
  ...
  burstSkill = [
    ...
    this.action("支援炮击伤害", AttackType.Burst, ElementType.Geo, {
