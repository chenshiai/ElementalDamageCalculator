...
export const Character: (ICharacterInfo & Record<any, any>)[] = [
  ...
  },
  {
    ...cha(10000109, "梦见月瑞希", ElementType.Anemo, WeaponType.Magic)(Rarity.Five, 12736, 215, 757, 60)(
      ...
      [
        "UI_Talent_S_Mizuki_01",
        "UI_Talent_S_Mizuki_02",
        "UI_Talent_U_Mizuki_01",
        "UI_Talent_S_Mizuki_03",
    ...
    elementSkill: [
      ...
      createAttack("持续攻击伤害", AttackType.Skill, ElementType.Anemo, {
    ...
    burstSkill: [
      ...
      createAttack("梦念冲击波伤害", AttackType.Burst, ElementType.Anemo, {
  ...
  },
  {
    ...
    elementSkill: [
      ...
      createAttack("贯夜伤害·基础", AttackType.Normal, ElementType.Electro, {
...

  {
    ...
    otherSkill: [
      createAttack("裂空之风", AttackType.Normal, ElementType.Anemo, {
        atk: [0.6],
      }),
    ],
    buffs: [
...

  {
    ...
    burstSkill: [
      createAttack("地震波单次伤害", AttackType.Burst, ElementType.Geo, {
        atk: [1.48, 1.59, 1.7, 1.85, 1.96, 2.07, 2.22, 2.37, 2.52, 2.66, 2.81, 2.96, 3.15, 3.33],
      }),
    ],
    otherSkill: [
      createAttack("狂乱的崩岩", AttackType.Normal, ElementType.Geo, {
        atk: [0.6],
      }),
    ],
    buffs: [
...

  {
    ...
    burstSkill: [
      ...
      createAttack("威光落雷伤害", AttackType.Burst, ElementType.Electro, {
...

  {
    ...
    burstSkill: [
      createAttack("草灯莲攻击伤害", AttackType.Burst, ElementType.Dendro, {
        atk: [0.802, 0.862, 0.922, 1.002, 1.062, 1.122, 1.202, 1.283, 1.363, 1.443, 1.523, 1.603, 1.703],
      }),
      createAttack("激烈爆发伤害", AttackType.Burst, ElementType.Dendro, {
