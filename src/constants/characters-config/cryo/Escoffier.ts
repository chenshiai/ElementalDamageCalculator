...
class EscoffierData extends Character implements ICharacterInfo {
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Escoffier"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Escoffier"),
  };
  ...
  elementSkill = [
    this.action("技能伤害", AttackType.Skill, ElementType.Cryo, {
      atk: [0.504, 0.542, 0.58, 0.63, 0.668, 0.706, 0.756, 0.806, 0.857, 0.907, 0.958, 1.008, 1.071],
    }),
    this.action("冻霜芭菲伤害", AttackType.Skill, ElementType.Cryo, {
  ...
  burstSkill = [
    this.action("技能伤害", AttackType.Burst, ElementType.Cryo, {
  ...
  otherSkill = [
    this.action("美食胜过良药", AttackType.Heal, ElementType.None, {
      atk: [1.3824],
    }),
    this.action("6命·特级冻霜芭菲伤害", AttackType.Skill, ElementType.Cryo, {
      atk: [5],
    }),
  ];
  buffs = [
