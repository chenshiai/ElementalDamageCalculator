...
class CitlaliData extends Character implements ICharacterInfo {
  constructor() {
    super();
  }
  enkaId = 10000107;
  ...
  icons = {
    avatarIcon: this.getEnkaUI("UI_AvatarIcon_Citlali"),
    ...
    gachaImage: this.getEnkaImg("UI_AvatarIcon_Citlali"),
  };
  ...
  normalAttack = [
    ...
    this.action("重击伤害", AttackType.Strong, ElementType.Cryo, {
  ...
  elementSkill = [
    this.action("黑曜星魔伤害", AttackType.Skill, ElementType.Cryo, {
    ...
    this.action("护盾吸收量", AttackType.Shield, ElementType.None, {
  ...
  burstSkill = [
    ...
    this.action("宿灵之髑伤害", AttackType.Burst, ElementType.Cryo, {
      atk: [1.344, 1.445, 1.546, 1.68, 1.781, 1.882, 2.016, 2.15, 2.285, 2.419, 2.554, 2.688, 2.856],
    }),
  ];
  otherSkill = [
    this.action("4命·宿灵之髑·黑星伤害", AttackType.Other, ElementType.Cryo, {
      em: [18],
    }),
  ];
  buffs = [
