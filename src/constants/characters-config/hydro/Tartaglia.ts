...
export class TartagliaData extends Character implements ICharacterInfo {
  ...
  normalAttack = [
    ...
    action("二段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.46268, 0.50034, 0.538, 0.5918, 0.62946, 0.6725, 0.73168, 0.79086, 0.85004, 0.9146, 0.97916, 1.04372, 1.10828,
        1.17284, 1.2374,
      ],
    }),
    action("三段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.55384, 0.59892, 0.644, 0.7084, 0.75348, 0.805, 0.87584, 0.94668, 1.01752, 1.0948, 1.17208, 1.24936, 1.32664,
        1.40392, 1.4812,
      ],
    }),
    action("四段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.57018, 0.61659, 0.663, 0.7293, 0.77571, 0.82875, 0.90168, 0.97461, 1.04754, 1.1271, 1.20666, 1.28622, 1.36578,
        1.44534, 1.5249,
      ],
    }),
    action("五段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.60888, 0.65844, 0.708, 0.7788, 0.82836, 0.885, 0.96288, 1.04076, 1.11864, 1.2036, 1.28856, 1.37352, 1.45848,
        1.54344, 1.6284,
      ],
    }),
    action("六段伤害", AttackType.Normal, ElementType.Physical, {
      atk: [
        0.72756, 0.78678, 0.846, 0.9306, 0.98982, 1.0575, 1.15056, 1.24362, 1.33668, 1.4382, 1.53972, 1.64124, 1.74276,
        1.84428, 1.9458,
      ],
    }),
    ...
    action("断流·闪 伤害·单次", AttackType.Normal, ElementType.Hydro, {
      atk: [
        0.124, 0.1333, 0.1426, 0.155, 0.1643, 0.1736, 0.186, 0.1984, 0.2108, 0.2232, 0.2356, 0.248, 0.2635, 0.279,
        0.2945,
      ],
    }),
    action("断流·破 伤害", AttackType.Normal, ElementType.Hydro, {
      atk: [0.62, 0.6665, 0.713, 0.775, 0.8215, 0.868, 0.93, 0.992, 1.054, 1.116, 1.178, 1.24, 1.3175, 1.395, 1.4725],
    }),
  ...
  elementSkill = [
    ...
    action("四段伤害", AttackType.Normal, ElementType.Hydro, {
      atk: [
        0.59942, 0.64821, 0.697, 0.7667, 0.81549, 0.87125, 0.94792, 1.02459, 1.10126, 1.1849, 1.26854, 1.35218, 1.43582,
        1.51946, 1.6031,
      ],
    }),
    action("五段伤害", AttackType.Normal, ElementType.Hydro, {
      atk: [
        0.55298, 0.59799, 0.643, 0.7073, 0.75231, 0.80375, 0.87448, 0.94521, 1.01594, 1.0931, 1.17026, 1.24742, 1.32458,
        1.40174, 1.4789,
      ],
    }),
    action("六段伤害·1", AttackType.Normal, ElementType.Hydro, {
      atk: [
        0.35432, 0.38316, 0.412, 0.4532, 0.48204, 0.515, 0.56032, 0.60564, 0.65096, 0.7004, 0.74984, 0.79928, 0.84872,
        0.89816, 0.9476,
      ],
    }),
    action("六段伤害·2", AttackType.Normal, ElementType.Hydro, {
      atk: [
        0.37668, 0.40734, 0.438, 0.4818, 0.51246, 0.5475, 0.59568, 0.64386, 0.69204, 0.7446, 0.79716, 0.84972, 0.90228,
        0.95484, 1.0074,
      ],
    }),
    action("重击伤害·1", AttackType.Strong, ElementType.Hydro, {
      atk: [0.602, 0.651, 0.7, 0.77, 0.819, 0.875, 0.952, 1.029, 1.106, 1.19, 1.274, 1.358, 1.442, 1.526, 1.61],
    }),
    action("重击伤害·2", AttackType.Strong, ElementType.Hydro, {
      atk: [
        0.71982, 0.77841, 0.837, 0.9207, 0.97929, 1.04625, 1.13832, 1.23039, 1.32246, 1.4229, 1.52334, 1.62378, 1.72422,
        1.82466, 1.9251,
      ],
    }),
  ...
  burstSkill = [
    action("技能伤害·近战", AttackType.Burst, ElementType.Hydro, {
      atk: [4.64, 4.988, 5.336, 5.8, 6.148, 6.496, 6.96, 7.424, 7.888, 8.352, 8.816, 9.28, 9.86, 10.44, 11.02],
    }),
