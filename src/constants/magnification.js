...
export const Magnification = {
  ...
  /** 阿蕾奇诺普通攻击【红死之宴提升值比例】 */
  Arlecchino: [1.204, 1.302, 1.4, 1.54, 1.638, 1.75, 1.904, 2.058, 2.212, 2.38, 2.548, 2.716, 2.884, 3.052],
  /** 玛拉妮鲨鲨撕咬【浪势充能提升倍率】 */
  Mualani: {
    en: [0.043, 0.047, 0.05, 0.054, 0.058, 0.061, 0.065, 0.069, 0.074, 0.078, 0.082, 0.087, 0.092],
    big: [0.217, 0.233, 0.25, 0.271, 0.288, 0.304, 0.334, 0.347, 0.369, 0.391, 0.412, 0.434, 0.461],
  },
  /** 玛薇卡【燔天之时提升倍率】 */
  Mavuika: {
    pg: [0.0026, 0.0028, 0.003, 0.0033, 0.0035, 0.0038, 0.0041, 0.0044, 0.0047, 0.0051, 0.0055, 0.0058, 0.0062],
    bf: [0.016, 0.0172, 0.0184, 0.02, 0.0212, 0.0224, 0.024, 0.0256, 0.0272, 0.0288, 0.0304, 0.032, 0.034]
  },
  /** 梦见月瑞希【秋沙歌枕巡礼】元素精通提升扩散伤害 */
  Mizuki: {
    sk: [0.18, 0.21, 0.24, 0.27, 0.30, 0.33, 0.36, 0.39, 0.42, 0.45, 0.48, 0.51, 0.54]
  },
  /** 伊安珊元素爆发提供攻击力的上限 */
  Iansan: [330, 370, 410, 450, 490, 530, 570, 610, 650, 690, 730, 770, 810],
  /** 菈乌玛元素爆发提高的绽放、超绽放、烈绽放伤害倍率 */
  Lauma: [2.7776, 2.98592, 3.19424, 3.472, 3.68032, 3.88864, 4.1664, 4.44416, 4.72192, 4.99968, 5.27744, 5.5552, 5.9024, 6.2496, 6.5968]
};
