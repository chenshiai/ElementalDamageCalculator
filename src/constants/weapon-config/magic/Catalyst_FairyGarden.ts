...
export const Catalyst_FairyGarden = createWeapon(
  ...
  (affix = 1) => {
    ...
    let d = [12, 15, 18, 21, 24][affix - 1] + "%";
    return {
      title: "末临者的华冠",
      text: highlight`攻击力提升${d}。装备者创造护盾后的20秒内，获得「先导之光」效果：依据装备者的攻击力，每1000点攻击力都会使队伍中自己的当前场上角色造成的伤害提升${a}，至多提升${b}。<br />此外，装备者创造护盾时，还会获得「指引者的餍足」效果，使装备者恢复${c}点元素能量，该效果每14秒至多触发一次；在不处于战斗状态下开启各类宝箱时，也会获得该效果。装备者处于队伍后台时，依然能触发上述效果。
